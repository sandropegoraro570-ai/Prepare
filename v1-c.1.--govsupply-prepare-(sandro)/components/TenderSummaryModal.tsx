...
const LongTextField: React.FC<{label: string; value?: string}> = ({ label, value }) => {
    ...
    return (
        <div>
            <dt className="font-medium text-medium-gray py-1">{label}</dt>
            ...
            <div className="p-2">
                ...
                <SummarySection title={t('tenderSummary.envelopesTitle')}>
                    {characteristics?.envelopeDocumentation_intro && (
                        <LongTextField value={getActiveVersionContent(characteristics.envelopeDocumentation_intro)} />
                    )}
                ...
                <SummarySection title={t('stage3.facilityVisitTitle')}>
                    <SummaryField 
                        ...
                        value={characteristics?.facilityVisitRequired ? t('general.yes') : t('general.no')} 
                    />
                </SummarySection>

                 {/* Stage 4 */}
                 <SummarySection title={t('tenderSummary.stage4Title')}>
                     <SummaryField label={t('tenderSummary.publicationDate')} value={data.stage4.publicationDate}/>
                     <SummaryField label={t('tenderSummary.platform')} value={data.stage4.platform}/>
                     <SummaryField label={t('tenderSummary.link')} value={data.stage4.link}/>
